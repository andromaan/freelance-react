...
import { useGetFreelancerByUserIdQuery } from "../../services/freelancer/freelancerApi";
import {
...
const FreelancerProfilePage: React.FC = () => {
  ...
  const { data: reviews = [], isLoading: isReviewsLoading } = useGetReviewsByEmailQuery(email, {
    skip: !email,
  });
  const { data: averageRating = 0, isLoading: isRatingLoading } = useGetAverageRatingQuery(email, {
    skip: !email,
  });
  ...
  if (!user || !freelancer) {
    return (
      <div className="min-h-[calc(100vh-64px)] bg-gray-50 dark:bg-gray-900 flex flex-col items-center justify-center p-8">
        ...
        <h2 className="text-xl font-bold text-gray-900 dark:text-white">Freelancer Not Found</h2>
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">This profile might be incomplete or does not exist.</p>
        <button
          onClick={() => navigate(-1)}
  ...
  const latestReviews = [...reviews].sort((a, b) => b.id.localeCompare(a.id)).slice(0, 3); // Showing 3 latest
          ...
          <div className="relative flex flex-col sm:flex-row gap-6 sm:items-end">
            ...
            <div className="flex-1 pb-2 mt-2 sm:mt-0">
              ...
              <div className="flex flex-wrap items-center gap-3 mt-2 text-sm text-gray-600 dark:text-gray-300">
                ...
                {/* Rating */}
                <div className="flex items-center gap-1.5" title={`${averageRating} average rating`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 sm:p-8 border border-gray-200 dark:border-gray-700 shadow-sm">
              <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-4 border-b border-gray-100 dark:border-gray-700 pb-2">About</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
              <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-4 border-b border-gray-100 dark:border-gray-700 pb-2">Skills</h2>
            ...
            {/* Portfolio */}
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm">
              <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-4 border-b border-gray-100 dark:border-gray-700 pb-2">Portfolio</h2>
              {freelancer.portfolio && freelancer.portfolio.length > 0 ? (
                ...
                <p className="text-gray-500 dark:text-gray-400 text-sm">Portfolio is empty.</p>
              )}
            </div>
          </div>
        </div>
